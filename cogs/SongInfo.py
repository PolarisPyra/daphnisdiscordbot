...
class SongInfo(commands.Cog):
    def __init__(self, bot):
        ...
        self.DifficultyMap = {0: "EASY", 1: "ADVANCE", 2: "EXPERT", 3: "MASTER", 4: "ULTIMA", 5: "WORLDS END"}
    ...
    async def songLookup(self, interaction: discord.Interaction, title: str, difficulty: str = None):
        ...
        try:
            ...
            if row is not None:
                ...
                # Create the embed
                embed = discord.Embed(title=f"Song Information: {row[1]}", color=discord.Color.blue())
